...
// import { Paragraph } from "./Paragraph";
// import { ReactComponent as DefaultIcon } from "../assets/default-icon.svg"; // example

// interface ExpertCardProps {
//   title?: string;
//   text?: string;
//   icon?: React.FunctionComponent<React.SVGProps<SVGSVGElement>>; // use SVG component
//   className?: string;
// }
...
//   return (
//     <div
//       className={`bg-white rounded-lg shadow-md w-[85%] max-w-[520px] min-h-[200px] flex flex-col items-center p-6 transition-transform duration-300 hover:scale-105 ${className}`}
//     >
//       {Icon && (
//         <Icon className="w-12 h-12 mb-4 text-[#2BA0A6]" />
//       )}
//       {title && (
//         <h3 className="text-lg font-semibold text-gray-800 text-center mb-2">
//           {title}
